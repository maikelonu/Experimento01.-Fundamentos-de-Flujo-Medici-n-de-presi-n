...
#setwd("/media/maikel/Trabajo/R_ITC/R_LABHYD/EXP_PRES")
setwd("C:/Users/TEC/Google Drive/FUNDA_R/R_LABHYD/EXP_PRES")
...
df.base <- read.table("test_manometros_05.txt", header = TRUE)
